// NumberProblem component
import { Recognize } from './recognize.js';
import { Speak } from './speak.js';

export const NumberProblem = {
  components: {
    Recognize,
    Speak
  },
  ...
  template: `
    <div>
      ...
      <div v-if="displayFormat === 'hear-type'" class="problem-display">
        <div class="instruction">Listen and type the number:</div>
        <Speak 
      ...
      <div v-if="displayFormat === 'hear-multiple-choice'" class="problem-display">
        <div class="instruction">Listen and select the number:</div>
        <Speak 
          :text="problem ? problem.answer : ''"
          :autoPlay="true"
          type="numbers"
      ...
      <div v-if="displayFormat === 'see-say'" class="problem-display">
        <div class="instruction">Say the number you see:</div>
