...
for (let group of homophone_list) {
  for (let word of group) {
    homophonesMap[word.toLowerCase()] = group;
  }
}

export function isHomophone(word1, word2) {
  if (homophonesMap[word1] === undefined || homophonesMap[word2] === undefined) return false;
  return homophonesMap[word1] === homophonesMap[word2];
}

export function getHomophones(word) {
  return homophonesMap[word.toLowerCase()] || [];
}
